...
#  Usage: irm https://raw.githubusercontent.com/microsoft/aibast-agents-library/main/rapp_cloud/install.ps1 | iex
#  Or:    .\install.ps1
# ═══════════════════════════════════════════════════════════════════════════════
...
function Install-RappCloud {
    ...
    if (-not (Test-Path (Join-Path $SourceDir "function_app.py"))) {
        Write-Err "Installation failed — RAPP Cloud source not found at $SourceDir"
    }
...
function Show-Success {
    ...
    Write-Host "  ✓ RAPP Cloud v$installedVersion installed!" -ForegroundColor Green
    Write-Host "  ═══════════════════════════════════════════════════" -ForegroundColor Green
    Write-Host ""
...
if ($args -contains "--help" -or $args -contains "-h") {
    Write-Host "RAPP Cloud Installer"
    Write-Host ""
    Write-Host "Usage:"
    Write-Host "  irm https://raw.githubusercontent.com/microsoft/aibast-agents-library/main/rapp_cloud/install.ps1 | iex"
