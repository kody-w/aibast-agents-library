...
RAPP Cloud is the **Azure Functions backend** for the RAPP (Rapid Agent Prototype Platform) ecosystem. It is the engine that powers agent creation, execution, and orchestration.
...
|-------------|------|---------------|
| **Bill Whalen** | RAPP Cloud-BillWhalen | Agent transpiler, Copilot Studio integration, performance optimizations, trigger system, MCS templates, architecture diagrams |
