    ...
    <ImportExportXml version="9.2.25114.191" SolutionPackageVersion="9.2" languagecode="1033" generatedBy="CrmLive" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
      <SolutionManifest>
        ...
        <Publisher>
          ...
          <Descriptions>
            <Description description="RAPP Cloud Publisher" languagecode="1033" />
          </Descriptions>
...
def _gpt_default_instructions_yaml() -> str:
    ...
    settings:
      modelConfiguration:
        instructions: >
          You are a Memory Agent for the RAPP Cloud platform. You help users store and recall
