# Getting Started with RAPP Cloud
...
2. ✅ Clones the RAPP Cloud repository
...
- `ASSISTANT_NAME` - Change from "RAPP Cloud" to your preferred name
...
- **Discussions**: [Ask questions](https://github.com/microsoft/aibast-agents-library/discussions)
- **Documentation**: [Browse all docs](index.md)

---

**Congratulations!** 🎉 You've successfully deployed your AI assistant. Enjoy building with RAPP Cloud!
