# RAPP Cloud - Complete Documentation

Welcome to the complete documentation for RAPP Cloud, an enterprise AI assistant platform built on Azure Functions with GPT-4 integration and Microsoft 365 capabilities.
...
RAPP Cloud is an enterprise-grade AI assistant that can be deployed in two modes:
