...
**Private Beta Access Required:** RAPP Cloud is currently in private beta. You must be invited to access the main repository. To request access, visit the public installer repo and follow the instructions.
...
The installer will:
- Check if you have access to the private RAPP Cloud repo
...
```bash
# Clone the private RAPP Cloud repo
git clone https://github.com/microsoft/aibast-agents-library.git
cd RAPP Cloud
...
| RAPP Cloud | Private Beta | Core RAPP platform and agents |
...
- **Bug reports:** Open an issue in the installer repo (for public issues) or RAPP Cloud (for beta members)
...
RAPP Cloud is in private beta. To request access:
