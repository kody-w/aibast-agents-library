...
```bash
cd <path-to>/aibast-agents-library/rapp_cloud
git add api-demo/
...
🔗 Test endpoints:
- Overview: https://raw.githubusercontent.com/microsoft/aibast-agents-library/main/rapp_cloud/api-demo/responses/<scenario>.json
- List: https://raw.githubusercontent.com/microsoft/aibast-agents-library/main/rapp_cloud/api-demo/scenarios/<scenario>/list.json

💡 Use in your app:
fetch('https://raw.githubusercontent.com/microsoft/aibast-agents-library/main/rapp_cloud/api-demo/responses/<scenario>.json')
```
...
const url = `https://raw.githubusercontent.com/microsoft/aibast-agents-library/main/rapp_cloud/api-demo/scenarios/crm/${scenario}.json`;
