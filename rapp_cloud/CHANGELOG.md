...
All notable changes to RAPP Cloud are documented here.
...
**The Great Cleanup** — Focused this repo solely on the RAPP Cloud Azure Functions backend and RAPP pipeline. Archived all RAPPverse/RAPPbook ecosystem code to `.rapp/`.
...
Integrated contributions from Bill Whalen's RAPP Cloud fork. Excluded customer directories, PII, and customer-specific transpiled agents.
...
The original RAPP Cloud repository containing the full RAPP ecosystem: Azure Functions backend, RAPPbook social feed, RAPPverse metaverse, RAPPzoo marketplace, content swarms, NPC systems, dimension factories, and more. This version is preserved in the `.rapp/` archive directory.

---

*Maintained by the RAPP Cloud community. See CONSTITUTION.md for contribution guidelines.*
