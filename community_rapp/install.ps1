...
git clone --depth 1 --quiet https://github.com/microsoft/aibast-agents-library.git $ProjectDir
...
if (-not (Test-Path $BizHtml)) {
    try {
        # TODO(aibast): business.html demo asset not yet hosted in this repo
        Invoke-WebRequest -Uri "https://raw.githubusercontent.com/microsoft/aibast-agents-library/main/business.html" -OutFile $BizHtml -UseBasicParsing
    } catch {}
}
