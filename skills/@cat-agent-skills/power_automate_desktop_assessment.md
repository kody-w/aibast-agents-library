...
requires_env: []
source_ref: @cat-agent-skills/power_automate_desktop_assessment
source_url: https://microsoft.github.io/cat-agent-skills/#power-automate-desktop-assessment
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#power-automate-desktop-assessment)), redistributed under
> **MIT** with attribution. Original author: Ricardo Calejo.
