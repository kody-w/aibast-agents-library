"""
Work Brief — RAPP agent, mirrored from work_brief.md
...
Do not edit this file. Edit work_brief.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#work-brief
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: A morning brief that reads your mail, calendar, and Teams, then tells you what you owe people before the week starts. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
...
SKILL_REF = "@cat-agent-skills/work_brief"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#work-brief"
