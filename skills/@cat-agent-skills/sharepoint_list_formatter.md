...
category: general
requires_env: []
source_ref: @cat-agent-skills/sharepoint_list_formatter
source_url: https://microsoft.github.io/cat-agent-skills/#sharepoint-list-formatter
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#sharepoint-list-formatter)), redistributed under
