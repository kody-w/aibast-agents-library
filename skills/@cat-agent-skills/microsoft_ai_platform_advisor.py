"""
Microsoft AI Platform Advisor — RAPP agent, mirrored from microsoft_ai_platform_advisor.md
...
Do not edit this file. Edit microsoft_ai_platform_advisor.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#microsoft-ai-platform-advisor
"""
...
__manifest__ = {
    ...
    "mirrors": "microsoft_ai_platform_advisor.md",
...
SKILL_PROCEDURE = """# Microsoft AI Platform Advisor
...
SKILL_REF = "@cat-agent-skills/microsoft_ai_platform_advisor"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#microsoft-ai-platform-advisor"
...
class MicrosoftAiPlatformAdvisorAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Microsoft AI Platform Advisor"
        self.metadata = {
            "name": self.name,
