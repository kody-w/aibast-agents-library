...
category: general
requires_env: []
source_ref: @cat-agent-skills/institutional_knowledge
source_url: https://microsoft.github.io/cat-agent-skills/#institutional-knowledge
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#institutional-knowledge)), redistributed under
