"""
AI Use Case Assessment — RAPP agent, mirrored from ai_usecase_assessment.md
...
Do not edit this file. Edit ai_usecase_assessment.md and re-run the exporter — the gate
re-derives this file and fails if the two have drifted apart.

Redistributed from CAT Agent Skills under MIT
with attribution. Original author: Alicja Gilderdale.
Origin: https://microsoft.github.io/cat-agent-skills/#ai-usecase-assessment
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Turn any AI/agentic use case idea (chat, uploaded doc, or attached file) into an evidence-grounded, rubric-scored assessment with a customer-branded HTML report. Guides the user question-by-question through intake, categorisation, strengthening, scoring, and reporting \\u2014 grounded in the Agentic Use Case Assessment Rubric v2. Runs in Microsoft Scout and Microsoft 365 Copilot Cowork. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    ...
    "mirrors": "ai_usecase_assessment.md",
...
SKILL_PROCEDURE = """# AI Use Case Assessment
...
SKILL_REF = "@cat-agent-skills/ai_usecase_assessment"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#ai-usecase-assessment"
...
class AiUsecaseAssessmentAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "AI Use Case Assessment"
        self.metadata = {
            "name": self.name,
