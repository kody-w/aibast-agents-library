...
requires_env: []
source_ref: @cat-agent-skills/exam_prep_learning_plan_builder
source_url: https://microsoft.github.io/cat-agent-skills/#exam-prep-learning-plan-builder
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#exam-prep-learning-plan-builder)), redistributed under
