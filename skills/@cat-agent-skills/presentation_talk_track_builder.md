...
category: general
requires_env: []
source_ref: @cat-agent-skills/presentation_talk_track_builder
source_url: https://microsoft.github.io/cat-agent-skills/#presentation-talk-track-builder
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#presentation-talk-track-builder)), redistributed under
> **MIT** with attribution. Original author: Jagmeet Chabra.
