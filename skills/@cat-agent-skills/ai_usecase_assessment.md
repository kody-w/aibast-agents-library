...
requires_env: []
source_ref: @cat-agent-skills/ai_usecase_assessment
source_url: https://microsoft.github.io/cat-agent-skills/#ai-usecase-assessment
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#ai-usecase-assessment)), redistributed under
> **MIT** with attribution. Original author: Alicja Gilderdale.
