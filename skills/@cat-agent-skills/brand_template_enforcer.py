"""
Brand Template Enforcer — RAPP agent, mirrored from brand_template_enforcer.md
...
Do not edit this file. Edit brand_template_enforcer.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#brand-template-enforcer
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Ensure every generated PowerPoint deck or Word document starts from the correct bundled or SharePoint-hosted brand template. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    ...
    "mirrors": "brand_template_enforcer.md",
...
SKILL_PROCEDURE = """# Brand Template Enforcer
...
SKILL_REF = "@cat-agent-skills/brand_template_enforcer"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#brand-template-enforcer"
...
class BrandTemplateEnforcerAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Brand Template Enforcer"
        self.metadata = {
            "name": self.name,
