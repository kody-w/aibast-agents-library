"""
Presentation Talk Track Builder — RAPP agent, mirrored from presentation_talk_track_builder.md
...
Do not edit this file. Edit presentation_talk_track_builder.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#presentation-talk-track-builder
"""
...
__manifest__ = {
    ...
    "mirrors": "presentation_talk_track_builder.md",
...
SKILL_PROCEDURE = """# Presentation Talk Track Builder
...
SKILL_REF = "@cat-agent-skills/presentation_talk_track_builder"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#presentation-talk-track-builder"
...
class PresentationTalkTrackBuilderAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Presentation Talk Track Builder"
        self.metadata = {
            "name": self.name,
