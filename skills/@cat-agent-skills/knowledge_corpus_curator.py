"""
Knowledge Corpus Curator — RAPP agent, mirrored from knowledge_corpus_curator.md
...
Do not edit this file. Edit knowledge_corpus_curator.md and re-run the exporter — the gate
re-derives this file and fails if the two have drifted apart.

Redistributed from CAT Agent Skills under MIT
with attribution. Original author: Doug Bellingeri.
Origin: https://microsoft.github.io/cat-agent-skills/#knowledge-corpus-curator
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Review uploaded knowledge-source files for duplication, redundancy, staleness, overlap, and potentially conflicting guidance, then produce an evidence-based curation backlog. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    ...
    "mirrors": "knowledge_corpus_curator.md",
...
SKILL_PROCEDURE = """# Knowledge Corpus Curator
...
SKILL_REF = "@cat-agent-skills/knowledge_corpus_curator"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#knowledge-corpus-curator"
...
class KnowledgeCorpusCuratorAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Knowledge Corpus Curator"
        self.metadata = {
            "name": self.name,
