...
requires_env: []
source_ref: @cat-agent-skills/awaiting_reply
source_url: https://microsoft.github.io/cat-agent-skills/#awaiting-reply
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#awaiting-reply)), redistributed under
> **MIT** with attribution. Original author: Allan De Castro.
