"""
Rich HTML Presentation — RAPP agent, mirrored from rich_html_presentation.md
...
Do not edit this file. Edit rich_html_presentation.md and re-run the exporter — the gate
re-derives this file and fails if the two have drifted apart.

Redistributed from CAT Agent Skills under MIT
with attribution. Original author: Henry Jammes.
Origin: https://microsoft.github.io/cat-agent-skills/#rich-html-presentation
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Create polished, self-contained HTML slide decks with keynote-style visuals, keyboard navigation, themes, animations, and reusable presentation components. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    "author": "Henry Jammes",
    "tags": [
        "presentations",
        "html",
    ...
    "mirrors": "rich_html_presentation.md",
...
SKILL_PROCEDURE = """# Rich HTML Presentation
...
SKILL_REF = "@cat-agent-skills/rich_html_presentation"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#rich-html-presentation"
...
class RichHtmlPresentationAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Rich HTML Presentation"
        self.metadata = {
            "name": self.name,
