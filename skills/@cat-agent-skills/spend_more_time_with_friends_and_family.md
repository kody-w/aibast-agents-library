...
category: general
requires_env: []
source_ref: @cat-agent-skills/spend_more_time_with_friends_and_family
source_url: https://microsoft.github.io/cat-agent-skills/#spend-more-time-with-friends-and-family
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#spend-more-time-with-friends-and-family)), redistributed under
