"""
Power BI Model Review — RAPP agent, mirrored from power_bi_model_review.md
...
Do not edit this file. Edit power_bi_model_review.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#power-bi-model-review
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Review a Power BI or Analysis Services semantic model (TMDL, BIM/JSON, or a pasted table/measure list) for relationship, DAX, date-handling, and naming issues, with corrected DAX for anything flagged. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    "author": "Tim Karlsson",
    "tags": [
        "power-bi",
        "dax",
    ...
    "mirrors": "power_bi_model_review.md",
...
SKILL_PROCEDURE = """# Power BI Model Review
...
SKILL_REF = "@cat-agent-skills/power_bi_model_review"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#power-bi-model-review"
...
class PowerBiModelReviewAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Power BI Model Review"
        self.metadata = {
            "name": self.name,
