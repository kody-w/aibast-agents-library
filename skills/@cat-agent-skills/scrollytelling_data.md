...
category: general
requires_env: []
source_ref: @cat-agent-skills/scrollytelling_data
source_url: https://microsoft.github.io/cat-agent-skills/#scrollytelling-data
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#scrollytelling-data)), redistributed under
