"""
Spend More Time With Friends & Family — RAPP agent, mirrored from spend_more_time_with_friends_and_family.md
...
Do not edit this file. Edit spend_more_time_with_friends_and_family.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#spend-more-time-with-friends-and-family
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: While you're out of office, watches a group chat and answers questions from your local knowledge docs (clearly marked AI-generated), logs anything it can't answer for later, and pings you on Teams if its setup is incomplete. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    ...
    "mirrors": "spend_more_time_with_friends_and_family.md",
...
SKILL_PROCEDURE = """# Spend More Time With Friends & Family
...
SKILL_REF = "@cat-agent-skills/spend_more_time_with_friends_and_family"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#spend-more-time-with-friends-and-family"


class SpendMoreTimeWithFriendsAndFamilyAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Spend More Time With Friends & Family"
        self.metadata = {
            "name": self.name,
