"""
Institutional Knowledge Archivist — RAPP agent, mirrored from institutional_knowledge.md
...
Do not edit this file. Edit institutional_knowledge.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#institutional-knowledge
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Preserve a departing senior leader's institutional knowledge \\u2014 decisions, rationale, relationships, and tribal knowledge \\u2014 by mining their M365 signals into a structured, multi-phase archive a successor can ground on. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    ...
    "mirrors": "institutional_knowledge.md",
...
SKILL_PROCEDURE = """# Institutional Knowledge Archivist
...
SKILL_REF = "@cat-agent-skills/institutional_knowledge"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#institutional-knowledge"
...
class InstitutionalKnowledgeAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Institutional Knowledge Archivist"
        self.metadata = {
            "name": self.name,
