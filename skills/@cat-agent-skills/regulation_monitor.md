...
requires_env: []
source_ref: @cat-agent-skills/regulation_monitor
source_url: https://microsoft.github.io/cat-agent-skills/#regulation-monitor
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#regulation-monitor)), redistributed under
