...
category: general
requires_env: []
source_ref: @cat-agent-skills/power_automate_documentation
source_url: https://microsoft.github.io/cat-agent-skills/#power-automate-documentation
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#power-automate-documentation)), redistributed under
