...
category: general
requires_env: []
source_ref: @cat-agent-skills/accessibility_pass
source_url: https://microsoft.github.io/cat-agent-skills/#accessibility-pass
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#accessibility-pass)), redistributed under
