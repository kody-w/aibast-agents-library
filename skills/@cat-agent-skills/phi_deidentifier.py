"""
PHI De-identifier — RAPP agent, mirrored from phi_deidentifier.md
...
Do not edit this file. Edit phi_deidentifier.md and re-run the exporter — the gate
re-derives this file and fails if the two have drifted apart.

Redistributed from CAT Agent Skills under MIT
with attribution. Original author: Rafael Lopez Alcaraz.
Origin: https://microsoft.github.io/cat-agent-skills/#phi-deidentifier
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Redact the 18 HIPAA Safe Harbor identifiers from clinical text (or produce a Limited Data Set) with consistent pseudonym tokens and an audit manifest of what was removed. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
...
SKILL_PROCEDURE = """# PHI De-identifier
...
SKILL_REF = "@cat-agent-skills/phi_deidentifier"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#phi-deidentifier"
