"""
Exam Prep Learning Plan Builder — RAPP agent, mirrored from exam_prep_learning_plan_builder.md
...
Do not edit this file. Edit exam_prep_learning_plan_builder.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#exam-prep-learning-plan-builder
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Build a personalized study plan app for an exam or certification: overview timeline, day-by-day schedule with a calendar picker, domain breakdown, one-click .ics download, and a notes tab to track confidence over time. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    ...
    "mirrors": "exam_prep_learning_plan_builder.md",
...
SKILL_PROCEDURE = """# Exam Prep Learning Plan Builder
...
SKILL_REF = "@cat-agent-skills/exam_prep_learning_plan_builder"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#exam-prep-learning-plan-builder"
...
class ExamPrepLearningPlanBuilderAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Exam Prep Learning Plan Builder"
        self.metadata = {
            "name": self.name,
