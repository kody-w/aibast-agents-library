"""
Redlining Content — RAPP agent, mirrored from redlining_content.md
...
Do not edit this file. Edit redlining_content.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#redlining-content
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Redlines a document based on changes from a template with Track Changes. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
...
SKILL_PROCEDURE = """# Redlining Content
...
SKILL_REF = "@cat-agent-skills/redlining_content"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#redlining-content"
