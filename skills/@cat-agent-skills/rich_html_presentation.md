...
category: general
requires_env: []
source_ref: @cat-agent-skills/rich_html_presentation
source_url: https://microsoft.github.io/cat-agent-skills/#rich-html-presentation
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#rich-html-presentation)), redistributed under
> **MIT** with attribution. Original author: Henry Jammes.
