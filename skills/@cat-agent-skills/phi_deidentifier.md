...
category: general
requires_env: []
source_ref: @cat-agent-skills/phi_deidentifier
source_url: https://microsoft.github.io/cat-agent-skills/#phi-deidentifier
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#phi-deidentifier)), redistributed under
> **MIT** with attribution. Original author: Rafael Lopez Alcaraz.
