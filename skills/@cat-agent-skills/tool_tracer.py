"""
Tool Tracer — RAPP agent, mirrored from tool_tracer.md
...
Do not edit this file. Edit tool_tracer.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#tool-tracer
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: On-demand tool/action trace for Copilot Studio runs (`/special-debug tool-trace` \\u2192 `tool_trace.json`). Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
...
SKILL_REF = "@cat-agent-skills/tool_tracer"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#tool-tracer"
