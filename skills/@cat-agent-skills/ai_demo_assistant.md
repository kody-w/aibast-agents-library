...
category: b2b_sales
requires_env: []
source_ref: @cat-agent-skills/ai_demo_assistant
source_url: https://microsoft.github.io/cat-agent-skills/#ai-demo-assistant
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#ai-demo-assistant)), redistributed under
> **MIT** with attribution. Original author: Doak Moore.
