...
category: general
requires_env: []
source_ref: @cat-agent-skills/generating_podcast_script
source_url: https://microsoft.github.io/cat-agent-skills/#generating-podcast-script
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#generating-podcast-script)), redistributed under
