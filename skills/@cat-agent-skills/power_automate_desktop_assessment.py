"""
Power Automate Desktop Assessment — RAPP agent, mirrored from power_automate_desktop_assessment.md
...
Do not edit this file. Edit power_automate_desktop_assessment.md and re-run the exporter — the gate
re-derives this file and fails if the two have drifted apart.

Redistributed from CAT Agent Skills under MIT
with attribution. Original author: Ricardo Calejo.
Origin: https://microsoft.github.io/cat-agent-skills/#power-automate-desktop-assessment
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Assess Power Automate Desktop and hybrid automation projects with evidence-based findings and prioritized remediation guidance. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    ...
    "mirrors": "power_automate_desktop_assessment.md",
...
SKILL_PROCEDURE = """# Power Automate Desktop Assessment
...
SKILL_REF = "@cat-agent-skills/power_automate_desktop_assessment"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#power-automate-desktop-assessment"
...
class PowerAutomateDesktopAssessmentAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Power Automate Desktop Assessment"
        self.metadata = {
            "name": self.name,
