...
requires_env: []
source_ref: @cat-agent-skills/own_voice_builder
source_url: https://microsoft.github.io/cat-agent-skills/#own-voice-builder
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#own-voice-builder)), redistributed under
