"""
LinkedIn Content Writer — RAPP agent, mirrored from linkedin_content_writer.md
...
Do not edit this file. Edit linkedin_content_writer.md and re-run the exporter — the gate
re-derives this file and fails if the two have drifted apart.

Redistributed from CAT Agent Skills under MIT
with attribution. Original author: Becky Still, Digital Boop Ltd.
Origin: https://microsoft.github.io/cat-agent-skills/#linkedin-content-writer
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Create credible LinkedIn content from facts, notes or drafts, with configurable voice and no invented evidence. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    ...
    "mirrors": "linkedin_content_writer.md",
...
SKILL_PROCEDURE = """# LinkedIn Content Writer
...
SKILL_REF = "@cat-agent-skills/linkedin_content_writer"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#linkedin-content-writer"
...
class LinkedinContentWriterAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "LinkedIn Content Writer"
        self.metadata = {
            "name": self.name,
