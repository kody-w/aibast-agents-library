...
category: general
requires_env: []
source_ref: @cat-agent-skills/brand_template_enforcer
source_url: https://microsoft.github.io/cat-agent-skills/#brand-template-enforcer
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#brand-template-enforcer)), redistributed under
