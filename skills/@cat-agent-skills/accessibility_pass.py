"""
Accessibility Pass — RAPP agent, mirrored from accessibility_pass.md
...
Do not edit this file. Edit accessibility_pass.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#accessibility-pass
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Check a PowerPoint deck, Word document, HTML page, or Markdown file against Microsoft's Accessibility Checker rules (missing alt text, untitled slides, headerless tables, low contrast, illogical reading order) and fix what it finds. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    "author": "Tim Karlsson",
    "tags": [
        "accessibility",
        "documents",
...
SKILL_PROCEDURE = """# Accessibility Pass
...
SKILL_REF = "@cat-agent-skills/accessibility_pass"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#accessibility-pass"
