"""
Podcast Script Generator — RAPP agent, mirrored from generating_podcast_script.md
...
Do not edit this file. Edit generating_podcast_script.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#generating-podcast-script
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Turn a topic or a pile of source material \\u2014 a newsletter, news digest, or set of articles \\u2014 into a two-host, NotebookLM-style podcast episode, with multi-voice SSML and optional Azure Text-to-Speech audio. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    "author": "Remi Dyon",
    "tags": [
        "content",
        "podcast",
    ...
    "mirrors": "generating_podcast_script.md",
...
SKILL_PROCEDURE = """# Podcast Script Generator
...
SKILL_REF = "@cat-agent-skills/generating_podcast_script"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#generating-podcast-script"
...
class GeneratingPodcastScriptAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Podcast Script Generator"
        self.metadata = {
            "name": self.name,
