"""
Power Automate Documentation — RAPP agent, mirrored from power_automate_documentation.md
...
Do not edit this file. Edit power_automate_documentation.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#power-automate-documentation
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Turns a Power Automate solution .zip into a clean markdown reference for every flow inside it: trigger, plain-English process, connection references, and a read/write/delete table for everything it touches. Maps which flows call each other and unresolved connections automatically. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    ...
    "mirrors": "power_automate_documentation.md",
...
SKILL_PROCEDURE = """# Power Automate Documentation
...
SKILL_REF = "@cat-agent-skills/power_automate_documentation"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#power-automate-documentation"
...
class PowerAutomateDocumentationAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Power Automate Documentation"
        self.metadata = {
            "name": self.name,
