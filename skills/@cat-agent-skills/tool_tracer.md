...
requires_env: []
source_ref: @cat-agent-skills/tool_tracer
source_url: https://microsoft.github.io/cat-agent-skills/#tool-tracer
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#tool-tracer)), redistributed under
