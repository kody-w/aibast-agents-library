"""
Own Voice Builder — RAPP agent, mirrored from own_voice_builder.md
...
Do not edit this file. Edit own_voice_builder.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#own-voice-builder
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Mines your sent emails to extract your real writing voice \\u2014 languages, tone modes, structure, vocabulary, taboo phrases \\u2014 and generates a personal voice skill that makes every email and Teams draft sound like you. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    "author": "Marcel",
    "tags": [
        "writing",
        "voice",
...
SKILL_PROCEDURE = """# Own Voice Builder
...
SKILL_REF = "@cat-agent-skills/own_voice_builder"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#own-voice-builder"
