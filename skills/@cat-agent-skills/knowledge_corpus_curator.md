...
category: general
requires_env: []
source_ref: @cat-agent-skills/knowledge_corpus_curator
source_url: https://microsoft.github.io/cat-agent-skills/#knowledge-corpus-curator
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#knowledge-corpus-curator)), redistributed under
> **MIT** with attribution. Original author: Doug Bellingeri.
