...
requires_env: []
source_ref: @cat-agent-skills/work_brief
source_url: https://microsoft.github.io/cat-agent-skills/#work-brief
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#work-brief)), redistributed under
