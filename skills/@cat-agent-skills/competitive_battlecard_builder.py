"""
Competitive Battlecard Builder — RAPP agent, mirrored from competitive_battlecard_builder.md
...
Do not edit this file. Edit competitive_battlecard_builder.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#competitive-battlecard-builder
"""
...
__manifest__ = {
    ...
    "mirrors": "competitive_battlecard_builder.md",
...
SKILL_PROCEDURE = """# Competitive Battlecard Builder
...
SKILL_REF = "@cat-agent-skills/competitive_battlecard_builder"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#competitive-battlecard-builder"
...
class CompetitiveBattlecardBuilderAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "Competitive Battlecard Builder"
        self.metadata = {
            "name": self.name,
