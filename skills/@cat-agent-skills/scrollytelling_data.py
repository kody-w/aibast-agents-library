"""
Scrollytelling Data — RAPP agent, mirrored from scrollytelling_data.md
...
Do not edit this file. Edit scrollytelling_data.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#scrollytelling-data
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Turns data into a scroll-driven HTML story. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    ...
    "mirrors": "scrollytelling_data.md",
...
SKILL_PROCEDURE = """# Scrollytelling Data
...
SKILL_REF = "@cat-agent-skills/scrollytelling_data"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#scrollytelling-data"
