"""
AI Demo Assistant — RAPP agent, mirrored from ai_demo_assistant.md
...
Do not edit this file. Edit ai_demo_assistant.md and re-run the exporter — the gate
re-derives this file and fails if the two have drifted apart.

Redistributed from CAT Agent Skills under MIT
with attribution. Original author: Doak Moore.
Origin: https://microsoft.github.io/cat-agent-skills/#ai-demo-assistant
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Turns a customer name, line of business, and personas into a ready-to-seed Microsoft 365 Copilot demo \\u2014 fictional Word/PowerPoint/Excel example files plus a full delivery and provisioning plan, with optional one-click seeding to OneDrive and Teams. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    "author": "Doak Moore",
    "tags": [
        "demo",
        "copilot",
...
SKILL_PROCEDURE = """# AI Demo Assistant
...
SKILL_REF = "@cat-agent-skills/ai_demo_assistant"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#ai-demo-assistant"
