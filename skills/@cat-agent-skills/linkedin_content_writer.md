...
requires_env: []
source_ref: @cat-agent-skills/linkedin_content_writer
source_url: https://microsoft.github.io/cat-agent-skills/#linkedin-content-writer
source_license: MIT
...
> **CAT Agent Skills** ([origin](https://microsoft.github.io/cat-agent-skills/#linkedin-content-writer)), redistributed under
> **MIT** with attribution. Original author: Becky Still, Digital Boop Ltd.
