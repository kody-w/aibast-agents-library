"""
SharePoint List Formatter — RAPP agent, mirrored from sharepoint_list_formatter.md
...
Do not edit this file. Edit sharepoint_list_formatter.md and re-run the exporter — the gate
...
Origin: https://microsoft.github.io/cat-agent-skills/#sharepoint-list-formatter
"""
...
__manifest__ = {
    ...
    "description": "Returns the verified RAPP procedure for: Turns any SharePoint list data into a clean, consistent markdown table. Dynamic columns based on list type and query, plus a one-click Open link for every row. Call this to obtain the full step-by-step contract (inputs, outputs, verification) and then carry out those steps.",
    ...
    "mirrors": "sharepoint_list_formatter.md",
...
SKILL_PROCEDURE = """# SharePoint List Formatter
...
SKILL_REF = "@cat-agent-skills/sharepoint_list_formatter"
SKILL_LICENSE = "MIT"
SKILL_SOURCE = "https://microsoft.github.io/cat-agent-skills/#sharepoint-list-formatter"


class SharepointListFormatterAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "SharePoint List Formatter"
        self.metadata = {
            "name": self.name,
