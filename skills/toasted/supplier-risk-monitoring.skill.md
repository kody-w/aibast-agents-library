...
requires_env: []
python_sha256: 2522324799069ac42b28b8612a1d57e23f4d9308e04d6190efb76b1b9a203193
python_filename: supplier_risk_monitoring_agent.py
---
...
Monitors supplier risk across quality, delivery, financial, and geopolitical dimensions with scorecards, disruption alerts, and alternative-sourcing plans.
...
```bash
python3 scripts/toast_skill.py extract supplier-risk-monitoring.skill.md
python3 supplier_risk_monitoring_agent.py
```
